...
var role_1 = __importDefault(require("./registry/role"));
var type_1 = __importDefault(require("./registry/type"));
...
var HiveGraph = /** @class */ (function (_super) {
    ...
    function HiveGraph(initialTypes, connector, hotReload) {
        ...
        _this.schemaUpdate = _this.schemaUpdate.bind(_this);
        _this.typeRegistry.on('add', _this.schemaUpdate);
        _this.typeRegistry.on('remove', _this.schemaUpdate);
    ...
    HiveGraph.prototype.getSchema = function () {
        var typeSchema = this.typeRegistry.schema;
        var roleSchema = this.roleRegistry.schema;
        var refreshSchema = graphql_compose_1.schemaComposer.clone();
        refreshSchema.merge(typeSchema);
        refreshSchema.merge(roleSchema);
        return typeSchema;
    };
    HiveGraph.prototype.schemaUpdate = function (args) {
        this.schema = this.getSchema();
        this.emit('schema_update', this.schema);
    };
    HiveGraph.prototype.executeRequest = function (query, variables) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, graphql_1.execute({
                            schema: this.schema,
    ...
    HiveGraph.prototype.addType = function (name, def) {
        this.typeRegistry.registerType(name, def);
        this.emit('type:add', name);
    };
    HiveGraph.prototype.removeType = function (name) {
        this.typeRegistry.deregisterType(name);
        this.emit('type:remove', name);
    };
    Object.defineProperty(HiveGraph.prototype, "typeSDL", {
        get: function () {
    ...
    HiveGraph.prototype.addTransport = function (setupFn) {
        this.transports.push(setupFn(this.typeRegistry.sdl));
    };
    return HiveGraph;
}(Emitter_1.default));
exports.default = HiveGraph;
