        ...
        graphql_compose_1.schemaComposer.Mutation.addFields((_b = {},
            _b[addKey] = {
                ...
                resolve: function (parent, args, context) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, context.connector.create(item.name, args[item.camelName])];
            ...
            _b[updateKey] = {
                ...
                resolve: function (parent, args, context) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, context.connector.update(item.name, args['id'], args[item.camelName])];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                }); }
            ...
            _b[deleteKey] = {
                ...
                resolve: function (parent, args, context) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, context.connector.delete(item.name, args['id'])];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                }); }
        ...
        graphql_compose_1.schemaComposer.Query.addFields((_c = {},
            _c[queryKey] = {
                ...
                resolve: function (parent, args, context) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, context.connector.read(item.name, args['id'])];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                }); }
            ...
            _c[queryAllKey] = {
                ...
                resolve: function (parent, args, context) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, context.connector.readAll(item.name)];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                }); }
